...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtValor.setBounds(78, 328, 70, 33);
	...
	private void  guardarReserva() {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("") 
			...
			LocalDate dataE = LocalDate.parse(((JTextField)txtFechaEntrada.getDateEditor()).getText());
			LocalDate dataS = LocalDate.parse(((JTextField)txtFechaSalida.getDateEditor()).getText()); 
	 ...
	 private void calcularValor(JDateChooser fechaE, JDateChooser fechaS) {
		 if(fechaE.getDate() != null && fechaS.getDate() != null) {
			if(fechaE.getDate().after(fechaS.getDate())) {
			 ...
			 int dias = -1;
			 int noche = 38000; //precio del costo por noche
			 int valor;
