...
public class Busqueda extends JFrame {
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas  >= 0) {
					...
					int confirmaH = JOptionPane.showConfirmDialog(null, "¿Desea borrar al huespede?");
	...
	private List<Reserva> buscarIDreserva(){
		return this.reservaControl.buscarID(txtBuscar.getText());
	}
	...
	private void ActualizarReservas() {
		...
		.ifPresent(fila ->{
			...
			if(tbReservas.getSelectedColumn() ==0) {
				...
				this.reservaControl.actualizarReserva(dataE, dataS, valor, formaPago, id);
	...
	private void actualizarHuespedes() {
	    Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
	        .ifPresentOrElse(filaHuespedes -> {
	            ...
	            // Verificar si el valor en la columna 3 no es nulo y tiene un formato válido
	            ...
	            if (fechaNacimientoStr != null && !fechaNacimientoStr.isEmpty()) {
	                try {
	                    ...
	                    JOptionPane.showMessageDialog(this, "Formato de fecha de nacimiento incorrecto.");
	        ...
	        }, () -> JOptionPane.showMessageDialog(this, "Por favor, no seas bobo!"));
	}
